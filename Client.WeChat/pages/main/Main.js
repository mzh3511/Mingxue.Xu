...
Page({
  ...
  load: function () {
    ...
    var list1 = wx.getStorageSync('personly_list')
  ...
  , editAddress: function (event) {
    ...
    if (touchTime > 350) {
      ...
      wx.navigateTo({
        url: '../detailed/detailed?id=' + pageid,
        success: function (res) {
  ...
  save: function () {
    wx.setStorageSync('person_list', this.data.arlist)
    wx.setStorageSync('personly_list', this.data.lylist1)
    this.load();
  },
  //按下事件开始  
  ...
  onClean:function(){
    var newlist;
    wx.setStorageSync('person_list', newlist);
    wx.setStorageSync('personly_list', newlist);
    wx.setStorageSync('pet_list', newlist);
    wx.setStorageSync('petly_list', newlist);
    wx.setStorageSync('ls_list', newlist);
    wx.setStorageSync('lsly_list', newlist);
  }
});