...
Page({
  ...
  load: function () {
    var list = wx.getStorageSync('ls_list')
    var list1 = wx.getStorageSync('lsly_list')
  ...
  , editAddress: function (event) {
    ...
    if (touchTime > 350) {
      ...
      wx.navigateTo({
        url: '../detailed3/detailed3?id=' + pageid,
        success: function (res) {
  ...
  save: function () {
    wx.setStorageSync('ls_list', this.data.arlist)
    wx.setStorageSync('lsly_list', this.data.lylist1)
    this.load();
  },
  //按下事件开始  
