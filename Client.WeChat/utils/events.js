...
// 页面注册事件
const pageEvent = {
    bz: [ 'topBallTap', 'scroll', 'searchInput', 'editBallTap', 'lower', 'reload', 'userHeadTap', 'bannerTap', 'searchTap', 'goWe', 'wxLogin', 'updateWxInfo', 'myBtnTap', 'myS', 'rtFinger', 'showMine', 'touchSP', 'touchSU', 'touchMU', 'touchMU', 'touchEU', 'touchCU'],
    bs: [ 'topBallTap', 'lower', 'reload', 'searchInput', 'userHeadTap', 'searchTap', 'searchFocus', 'clearRecents', 'deleteRecent', 'recentSearch', 'closeRecent'],
    bg: [ 'topBallTap', 'lower', 'reload', 'userHeadTap', 'rankTap', 'bannerTap'],
    ug: [ 'topBallTap', 'scroll', 'lower', 'reload', 'goWe', 'guyS'],
    uf: [ 'topBallTap', 'scroll', 'touchS', 'touchM', 'reload', 'lower', 'editBallTap'],
